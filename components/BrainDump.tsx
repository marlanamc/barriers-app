...
export function BrainDump({ onAddInboxItem, onAddFutureItem, isExpanded = false }: BrainDumpProps) {
    ...
    return (
        <div className="w-full max-w-2xl mx-auto mb-6">
            <div className={`relative transition-all duration-200 ease-in-out ${isExpanded ? 'scale-100 opacity-100' : 'scale-95 opacity-90'
                }`}>
                <div className="relative flex items-center gap-2 rounded-2xl bg-white p-2 shadow-sm ring-1 ring-slate-200 focus-within:ring-2 focus-within:ring-cyan-500 dark:bg-slate-800 dark:ring-slate-700">
                    <input
                        ...
                        placeholder="Brain dump... (Type & Enter)"
                    ...
                    <button
                        ...
                        className="rounded-xl bg-cyan-600 p-2 text-white transition-all hover:bg-cyan-700 disabled:opacity-50 disabled:hover:bg-cyan-600"
                    >
